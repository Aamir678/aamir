...
export function generateTimetable(
  ...
  const days: DaySchedule[] = workingDays.map(day => {
    ...
    // Add break time
    entries.push({
      subject: { id: 0, name: "Morning Break", teacher: "", periodsPerWeek: 0, color: "#F59E0B", code: "BREAK" },
    ...
    // Add lunch time
    entries.push({
      subject: { id: 0, name: "Lunch Break", teacher: "", periodsPerWeek: 0, color: "#F59E0B", code: "LUNCH" },
